<script lang="ts">
	...
	function navigateToCreateSlice() {
		goto('/crear-slice');
	}

	function navigateToSliceInfo(slice: any) {
...
<div class="min-h-screen p-4" style="background-color: #806CF2;">
	...
	<!-- Slices List -->
	<!-- Changed from horizontal flex wrap to vertical column layout with full width -->
	<div
		style="
			display: flex;
